...
######### Paths defintions:
set -x
output=/home/groups/hpcbio_shared/azza/human_WES_multi_sample_synthetic/results/run7
goldenFile=/home/groups/hpcbio_shared/azza/human_WES_multi_sample_synthetic/data/reads/synthetic.Oct_chr123.16/sample.1/Chunks/synthetic.Oct_chr123.16_golden.vcf
workflowFile=$output/delivery/jointVCFs/jointVCFcalled.vcf

export HGREF=/home/groups/hpcbio_shared/azza/human_WES_multi_sample_synthetic/data/genome//HG19_GATKbundle2.8_chr1_chr2_chr3.fa
